...
//   options: [
//     { label: "১২ কেজি", value: 12, price: 1200 },
//     { label: "২৪ কেজি", value: 24, price: 2300 },
//   ],
//   image1: "/img.jpeg",
//   image2: "/img.jpeg",
//   image3: "/img.jpeg",
...
//       },
//     });
//   //   await fetch('https://script.google.com/macros/s/AKfycbzksyVxm4I4hMQIJMrKfER6npuHjbCF9_CKby6deenw-QZ_MaskdXvFhKG6R2D33FmT/exe', {
//   //     method: "POST",
//   //     headers: {
//   //         "Content-Type": "application/json"
//   //     },
...
//             </div>
//             <div>
//               <label className="block text-green-800 font-semibold mb-1" htmlFor="address">ঠিকানা</label>
//               <textarea
//                 required
//                 className="w-full border border-green-300 rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-green-400"
//                 id="address"
...
//                 <li><strong>ঠিকানা:</strong> {form.address}</li>
